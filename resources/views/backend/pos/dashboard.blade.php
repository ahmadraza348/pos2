            ...
            <div class="row">
                <div class="col-lg-8 col-sm-12 tabs_wrapper">
                    ...
                    <ul class="tabs owl-carousel owl-theme owl-product border-0">
                        ...
                        <li id="fruits" class="active">
                            <div class="product-details">
                                <img src="{{asset('backend/assets/img/product/product62.png')}}" alt="img" />
                                <h6>Fruits</h6>
                            </div>
                        </li>   
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-sm-6 d-flex">
                                    <div class="productset flex-fill active">
                                        <div class="productsetimg">
                                            <img src="{{asset('backend/assets/img/product/product29.jpg')}}" alt="img" />
                                            <h6>Qty: 5.00</h6>
                                ...
                                <div class="col-lg-3 col-sm-6 d-flex">
                                    <div class="productset flex-fill">
                                        <div class="productsetimg">
                                            <img src="{{asset('backend/assets/img/product/product31.jpg')}}" alt="img" />
                                            <h6>Qty: 1.00</h6>
                                            <div class="check-product">
                                                <i class="fa fa-check"></i>
                                            </div>
                                ...
                                <div class="col-lg-3 col-sm-6 d-flex">
                                    <div class="productset flex-fill">
                                        <div class="productsetimg">
                                            <img src="{{asset('backend/assets/img/product/product35.jpg')}}" alt="img" />
                                            <h6>Qty: 5.00</h6>
                                            <div class="check-product">
                                                <i class="fa fa-check"></i>
                                            </div>
                                ...
                                <div class="col-lg-3 col-sm-6 d-flex">
                                    <div class="productset flex-fill">
                                        <div class="productsetimg">
                                            <img src="{{asset('backend/assets/img/product/product37.jpg')}}" alt="img" />
                                            <h6>Qty: 5.00</h6>
                                            <div class="check-product">
                                                <i class="fa fa-check"></i>
                                            </div>
                                ...
                                <div class="col-lg-3 col-sm-6 d-flex">
                                    <div class="productset flex-fill">
                                        <div class="productsetimg">
                                            <img src="{{asset('backend/assets/img/product/product54.jpg')}}" alt="img" />
                                            <h6>Qty: 5.00</h6>
                                            <div class="check-product">
                                                <i class="fa fa-check"></i>
                                            </div>
                            ...
                            <ul>
                                <li>
                                    <a href="javascript:void(0);" class="deletebg confirm-text"><img
                                            src="{{asset('backend/assets/img/icons/delete-2.svg')}}" alt="img" /></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0);" data-bs-toggle="dropdown" aria-expanded="false"
                                        class="dropset">
                                        <img src="{{asset('backend/assets/img/icons/ellipise1.svg')}}" alt="img" />
                                    </a>
                    ...
                    <div class="card card-order">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="text-end">
                                        <a class="btn btn-scanner-set"><img src="{{asset('backend/assets/img/icons/scanner1.svg')}}"
                                    ...
                                    <li>
                                        <div class="productimg">
                                            <div class="productimgs">
                                                <img src="{{asset('backend/assets/img/product/product30.jpg')}}" alt="img" />
                                            </div>
                                                ...
                                                <h4>
                                                    ...
                                                    <a href="javascript:void(0);" class="ms-2"
                                                        data-bs-toggle="modal" data-bs-target="#edit"><img
                                                            src="{{asset('backend/assets/img/icons/edit-5.svg')}}" alt="img" /></a>
                                                </h4>
                        ...
                        <div class="card-body pt-0 pb-2">
                                ...
                                <ul>
                                    <li>
                                        <a href="javascript:void(0);" class="paymentmethod">
                                            <img src="{{asset('backend/assets/img/icons/cash.svg')}}" alt="img" class="me-2" />
                                            Cash
                                        </a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0);" class="paymentmethod">
                                            <img src="{{asset('backend/assets/img/icons/debitcard.svg')}}" alt="img"
                                                class="me-2" />
                                            Debit
                                        </a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0);" class="paymentmethod">
                                            <img src="{{asset('backend/assets/img/icons/scan.svg')}}" alt="img" class="me-2" />
                                            Scan
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <div class="btn-pos">
                                <ul>
                                    <li>
                                        <a class="btn"><img src="{{asset('backend/assets/img/icons/pause1.svg')}}" alt="img"
                                                class="me-1" />Hold</a>
                                    </li>
                                    <li>
                                        <a class="btn"><img src="{{asset('backend/assets/img/icons/edit-6.svg')}}" alt="img"
                                                class="me-1" />Quotation</a>
                                    </li>
                                    <li>
                                        <a class="btn"><img src="{{asset('backend/assets/img/icons/trash12.svg')}}" alt="img"
                                                class="me-1" />Void</a>
                                    </li>
                                    <li>
                                        <a class="btn"><img src="{{asset('backend/assets/img/icons/wallet1.svg')}}" alt="img"
                                                class="me-1" />Payment</a>
                                    </li>
                                    <li>
                                        <a class="btn" data-bs-toggle="modal" data-bs-target="#recents"><img
                                                src="{{asset('backend/assets/img/icons/transcation.svg')}}" alt="img"
                                                class="me-1" />
                                            Transaction</a>
                                    </li>
                                </ul>
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="javascript:void(0);" class="btn btn-closes"><img
                                    src="{{asset('backend/assets/img/icons/close-circle.svg')}}" alt="img" /></a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="javascript:void(0);" class="btn btn-reverse"><img
                                    src="{{asset('backend/assets/img/icons/reverse.svg')}}" alt="img" /></a>
                        </li>
                    </ul>
                </div>
            </div>
